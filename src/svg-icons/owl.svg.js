...
export const OwlIconSvg = ({ width, height }) => (
  <svg height={height} viewBox="0 0 64 64" width={width}>
    ...
    <g id="Head">
      <g>
        <path
          d="M47.138,8.37C47.588,5.736,48,2.617,48,0 c-2.253,0-5.139,3.697-6.756,6.064C40.835,6.022,40.42,6,40,6c-3.078,0-5.876,1.169-8,3.073C29.876,7.169,27.078,6,24,6 c-0.42,0-0.835,0.022-1.244,0.064C21.139,3.697,18.253,0,16,0c0,2.617,0.412,5.736,0.862,8.369C13.917,10.556,12,14.05,12,18 c0,6.628,5.372,12,12,12c3.078,0,5.876-1.169,8-3.073C34.124,28.831,36.922,30,40,30c6.627,0,12-5.372,12-12 C52,14.05,50.083,10.557,47.138,8.37z"
          fillRule="evenodd"
          clipRule="evenodd"
          fill="#A67A51"
        />
    ...
    <g id="Face">
      <g>
        <path
          d="M40,10c-4.418,0-8,3.582-8,8c0-4.418-3.582-8-8-8 s-8,3.582-8,8c0,4.419,3.582,8.001,8,8.001c1.933,0,3.705-0.686,5.088-1.826L32,30l2.912-5.825 c1.383,1.141,3.155,1.826,5.088,1.826c4.418,0,8-3.582,8-8.001C48,13.582,44.418,10,40,10z"
          fillRule="evenodd"
          clipRule="evenodd"
          fill="#E6E6E6"
        />
